				...
				<form action="${contextPath}/update.do" method="post">
					...
					<table class="table table-bordered"
						...
						<tr>
							...
							<td colspan="2"><input value="${mvo.memName}" type="text" name="memName"
								id="memName" placeholder="이름을 입력해주세요" class="form-control"
								maxlength="20"></td>
						</tr>
						<tr>
							<td style="width: 110px; vertical-align: middle;">나이</td>
							<td colspan="2"><input value="${mvo.memAge}" type="number" name="memAge"
										...
										<c:choose>
											<c:when test="${mvo.memGender eq '남자' }"> <!-- if문 -->
												<label class="btn btn-primary active"> <input
													type="radio" id="memGender" name="memGender" value="남자" checked>남자
											...
											<c:otherwise>
												<label class="btn btn-primary"> <input
													...
													id="memGender" name="memGender" value="여자" checked>여자
												</label>
											</c:otherwise>
										</c:choose>
						...
						<tr>
							...
							<td colspan="2"><input value="${mvo.memEmail}" type="email" name="memEmail"
